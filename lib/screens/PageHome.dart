...
class PageHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final pageC = Get.find<PagexController>();
                    ...
                    TextField(
                      decoration: InputDecoration(
                        ...
                        focusedBorder: OutlineInputBorder(
                            borderSide: BorderSide(color: mkWhite, width: 0.5),
                            borderRadius: BorderRadius.circular(26)),
                        enabledBorder: OutlineInputBorder(
                            borderSide:
                                BorderSide(color: mk_view_color, width: 0.5),
                            borderRadius: BorderRadius.circular(26)),
                      ),
                    ),
                    GestureDetector(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: <Widget>[
                        ...
                        MasjidListing(mListings: pageC.mListing, width: width),
                      ],
                    ),
                  ),
                ),
