...
//     {double radius = 80.0,
//     Color? backGroundColor = mkColorPrimary,
...
//   return Container(
//     decoration:
//         boxDecoration(radius: 16, shadowColor: mkColorPrimary.withAlpha(30)),
...
//           child: Text(
//             'Edit',
//             style: primaryTextStyle(color: mkColorPrimary, size: 16),
//           ),
//         ),
//       ],
//     ),
...
Widget oPDotIndicator({required bool isActive}) {
  return AnimatedContainer(
    ...
    decoration: BoxDecoration(
      color: isActive ? mkColorPrimary : Colors.grey.withOpacity(0.5),
      borderRadius: BorderRadius.all(Radius.circular(50)),
    ),
  );
}
