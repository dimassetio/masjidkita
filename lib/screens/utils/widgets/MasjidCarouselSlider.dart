...
class MasjidCarouselSlider extends StatefulWidget {
  MasjidCarouselSlider(
  ...
  /// The initial page to show when first creating the [MasjidCarouselSlider].
  ///
  /// Defaults to 0.
  ...
  /// Animates the controlled [MasjidCarouselSlider] to the next page.
  ///
  ...
  /// Animates the controlled [MasjidCarouselSlider] to the previous page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  /// Changes which page is displayed in the controlled [MasjidCarouselSlider].
  ///
  ...
  /// Animates the controlled [MasjidCarouselSlider] from the current page to the given page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ...
  @override
  _MasjidCarouselSliderState createState() => _MasjidCarouselSliderState();
}

class _MasjidCarouselSliderState extends State<MasjidCarouselSlider>
